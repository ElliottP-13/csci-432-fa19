...
This example gives context to what Shor's quantum algorithm seeks to accomplish, without diving into the details of it.
The reason we chose this $+1$ is because we found it impossible to improve, provide a runtime analysis, or compare to other algorithms a quantum algorithm.
